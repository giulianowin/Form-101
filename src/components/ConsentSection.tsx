  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-2xl" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '800' }}>
      <div className="space-y-4">
        <div className="text-slate-200 text-sm leading-relaxed" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '800' }}>
          <p className="font-semibold mb-3" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '800' }}>I understand and Consent that my information will be:</p>
          
          <div className="space-y-3 mb-4">
            <p style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '800' }}>
          ...
          <p className="font-medium" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '800' }}>I understand I can request access to or deletion of my information at any time.</p>
        </div>
      ...
      {errors.consent && <p className="text-yellow-400 text-sm mt-1" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: '800' }}>{errors.consent}</p>}
    </div>
  );
};
