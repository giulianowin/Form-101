    ...
    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 shadow-2xl" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>
      <div className="space-y-4">
        <div className="text-slate-200 text-sm leading-relaxed">
          <p className="mb-3" style={{ fontWeight: 600 }}>I understand and Consent that my information will be:</p>
          ...
          <p style={{ fontWeight: 600 }}>I understand I can request access to or deletion of my information at any time.</p>
        </div>
