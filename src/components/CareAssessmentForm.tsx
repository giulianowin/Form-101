    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl text-white mb-4" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>Care Assessment Form</h1>
          <p className="text-slate-300 text-lg" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>Please complete the required fields to help us provide the best care service for you</p>
        </div>

        {submitSuccess && (
          <div className="mb-8 p-4 bg-green-500/20 border border-green-500/50 rounded-lg backdrop-blur-sm">
            <p className="text-green-300 text-center" style={{ fontFamily: 'Montserrat, sans-serif', fontWeight: 600 }}>Form submitted successfully! We will be in touch soon.</p>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="text-center">
            <button
              ...
              className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-4 px-8 rounded-lg shadow-lg transform transition-all duration-200 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed flex items-center mx-auto"
