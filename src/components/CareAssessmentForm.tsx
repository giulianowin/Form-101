    ...
    try {
      const submissionData = {
        serviceUserDetails: {
          ...
          clientStartDate: serviceUserDetails.clientStartDate,
        ...
        medicalBackgroundInformation: {
          ...
          hospitalAdmissionHistory: medicalBackgroundInformation.hospitalAdmissionHistory,
          mobilitySupport: medicalBackgroundInformation.mobilitySupport,
          skinIntegrityNeeds: medicalBackgroundInformation.skinIntegrityNeeds,
          dnarInPlace: medicalBackgroundInformation.dnarInPlace,
          careVisitFrequency: medicalBackgroundInformation.careVisitFrequency,
          careVisitDuration: medicalBackgroundInformation.careVisitDuration,
