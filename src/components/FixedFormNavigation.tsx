    ...
    <>
      ...
      {currentSectionIndex > 0 && (
        <button
          ...
          className="fixed left-0 top-1/2 transform -translate-y-1/2 h-96 w-20 z-[9999] flex flex-col justify-center items-center bg-gray-900 hover:bg-gray-800 rounded-2xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 shadow-2xl"
