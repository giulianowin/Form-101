...
export const getRequiredFieldsStatus = (formData: FormData, errors: FormErrors): RequiredFieldsStatus => {
  ...
  const clientDetailsFields = [
    ...
    { field: 'phoneNumber', isValid: () => formData.phoneNumber && formData.phoneNumber !== '07' && isValidPhone(formData.phoneNumber) && !errors.phoneNumber },
  ...
  const nextOfKinFields = [
    ...
    { field: 'nextOfKinPhone', isValid: () => formData.nextOfKinPhone && formData.nextOfKinPhone !== '07' && isValidPhone(formData.nextOfKinPhone) && !errors.nextOfKinPhone },
